...
{
    algorithm_entity.algorithmParameter.variable_number = 10;
    algorithm_entity.algorithmParameter.objective_number = 3;
    algorithm_entity.algorithmParameter.max_evaluation = 500;
    algorithm_entity.algorithmParameter.population_size = 100;
    algorithm_entity.test_problem = DTLZ2;
    algorithm_entity.algorithmParameter.output_interval = 1000;
    algorithm_entity.fitness_scaling_factor = 0.05;
